...
| `clients/kitabim-ocr/` | Standalone local OCR client (currently Surya OCR) — not part of the deployed product, not containerized, talks to the backend only over its public API |
