...
- PostgreSQL runs as a **standalone service on the host machine** — not a Docker container. Containers connect via `host.docker.internal:5432`; connect from the host at `localhost:5432`.
