...
from app.services.langchain_service import PromptChainFactory
...
class SpellCheckService:
    def __init__(self) -> None:
        self.chain = PromptChainFactory.build_text_chain(SPELL_CHECK_PROMPT, settings.gemini_model_name)
