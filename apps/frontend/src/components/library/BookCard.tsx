    ...
    <>
      ...
      {showSummary && createPortal(
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-2 sm:p-4 md:p-8" dir="rtl" lang="ug">
          ...
          />
          <div
            className="bg-white/90 dark:bg-slate-950/90 backdrop-blur-2xl rounded-[24px] sm:rounded-[32px] md:rounded-[40px] shadow-[0_32px_128px_rgba(0,0,0,0.3)] w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] relative z-10 overflow-hidden animate-scale-up border border-white/40 dark:border-slate-800 flex flex-col"
          ...
          >
            ...
            <div className="p-4 pb-3 sm:p-6 sm:pb-4 md:p-8 md:pb-6 border-b border-slate-100 dark:border-slate-800 flex items-start justify-between bg-white/50 dark:bg-slate-900/50">
              <div className="flex items-center gap-3 sm:gap-4 md:gap-6">
                <div className="p-2.5 sm:p-3 md:p-4 bg-[#0369a1] dark:bg-[#38bdf8] text-white dark:text-slate-950 rounded-2xl sm:rounded-[24px] shadow-xl shadow-[#0369a1]/20 shrink-0">
              ...
              <button
                onClick={() => setShowSummary(false)}
                className="p-2 sm:p-3 hover:bg-red-50 dark:hover:bg-red-950/30 text-slate-300 dark:text-slate-600 hover:text-red-500 dark:hover:text-red-400 rounded-2xl transition-all active:scale-95 group shrink-0"
              >
            ...
            {/* Content */}
            <div className="flex-grow overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden p-4 sm:p-6 md:p-10 bg-[#f8fafc]/30 dark:bg-slate-900/30">
              {isLoadingSummary ? (
                ...
                <div className="bg-white/80 dark:bg-slate-900/80 p-4 pt-8 sm:p-6 sm:pt-10 md:p-10 md:pt-12 rounded-[20px] sm:rounded-[24px] md:rounded-[32px] shadow-sm border border-white dark:border-slate-800 relative overflow-hidden">
