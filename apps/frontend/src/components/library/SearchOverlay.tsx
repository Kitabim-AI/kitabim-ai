...
export const SearchOverlay: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1400px] h-full h-max-[90dvh] bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl rounded-[40px] shadow-[0_32px_128px_rgba(0,0,0,0.2)] dark:shadow-black/50 overflow-hidden flex flex-col animate-fade-in border border-white/40 dark:border-slate-800">
        {/* Header */}
        <div className="w-full bg-white/50 dark:bg-slate-900/50 border-b border-[#0369a1]/10 dark:border-slate-800 px-4 py-4 md:px-10 md:py-8 flex items-center gap-3 md:gap-6 shadow-sm">
          {/* Search Icon & Input Group */}
          <div className="flex items-center gap-3 md:gap-4 flex-grow min-w-0">
            <div className="p-2 md:p-3 bg-[#0369a1] dark:bg-[#38bdf8] text-white dark:text-slate-950 rounded-xl md:rounded-2xl shadow-lg shadow-[#0369a1]/20 dark:shadow-[#38bdf8]/10 flex-shrink-0">
          ...
          <button
            ...
            className="p-2 md:p-3 bg-slate-50 dark:bg-slate-800 text-slate-400 dark:text-slate-500 rounded-xl md:rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-600 dark:hover:text-slate-300 transition-all active:scale-95 flex-shrink-0"
          ...
          {books.length > 0 ? (
            ...
            <div className="flex-grow flex flex-col items-center justify-center p-6 md:p-12 text-center">
              ...
              <div className="flex flex-col items-center justify-center py-12 md:py-20 text-center opacity-40 animate-fade-in">
                <div className="p-6 md:p-8 bg-slate-100/50 dark:bg-slate-800/50 rounded-full mb-6 md:mb-10 ring-[8px] md:ring-[12px] ring-slate-50/50 dark:ring-slate-900/50">
            ...
            <div className="h-[50vh] flex flex-col items-center justify-center">
              <div className="w-16 h-16 border-4 border-[#0369a1]/10 dark:border-[#38bdf8]/10 border-t-[#0369a1] dark:border-t-[#38bdf8] rounded-full animate-spin mb-4"></div>
              <span className="text-sm font-black text-[#0369a1] dark:text-[#38bdf8] uppercase animate-pulse">{t('common.loading')}...</span>
            </div>
          )}
          ...
          {globalSearchQuery.trim().length >= 3 && (
            <div ref={loaderRef as any} className="py-20 flex flex-col items-center justify-center gap-6">
              ...
              <div className="flex flex-col items-center gap-4 animate-fade-in">
                <div className="w-10 h-10 border-4 border-[#0369a1]/10 dark:border-[#38bdf8]/10 border-t-[#0369a1] dark:border-t-[#38bdf8] rounded-full animate-spin"></div>
