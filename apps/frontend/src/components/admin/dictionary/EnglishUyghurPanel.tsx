      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full gap-3 md:gap-4">
        <div className="relative flex-1 lg:flex-none lg:w-[40%] group w-full">
          ...
          <input
            ...
            className="w-full pr-11 md:pr-14 pl-10 md:pl-11 py-2.5 md:py-3 bg-white border-2 border-[#0369a1]/10 rounded-2xl outline-none focus:border-[#0369a1] transition-all shadow-sm placeholder:text-slate-300 text-base"
        ...
        {stats && (
          <div className="flex items-center gap-2 text-[12px] md:text-[14px] font-normal text-[#0369a1] bg-[#0369a1]/10 px-3 md:px-4 py-2 md:py-2.5 rounded-full border border-[#0369a1]/20 shadow-sm whitespace-nowrap self-end md:self-auto">
            ...
            <div className="glass-panel rounded-[32px] p-2 overflow-hidden shadow-xl animate-fade-in border border-[#0369a1]/5">
              <div className="grid grid-cols-1 gap-1">
                {activeEntries.map((entry) => (
                  <div
                    key={entry.id}
                    className="flex items-start justify-between px-4 md:px-6 py-4 md:py-5 rounded-2xl transition-all group hover:bg-slate-50/50"
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-baseline gap-2 md:gap-3">
                        <span className="text-[16px] md:text-xl font-bold text-slate-800">
                          {entry.english}
                        </span>
                      </div>
                      <p className="uyghur-text text-[13px] md:text-[14px] text-slate-500 font-normal leading-relaxed mt-1.5 whitespace-pre-wrap" dir="rtl" lang="ug">
                        {entry.uyghur}
                      </p>
                    </div>
                  </div>
