...
export const TagEditor: React.FC<TagEditorProps> = ({
      ...
      <div className="flex flex-col gap-2 min-w-[180px]" dir="rtl">
        ...
        <div className="flex gap-1 items-center">
          <input
            ...
            onKeyDown={e => e.key === 'Enter' ? (tempValue.trim() ? onAddItem(tempValue.trim()) : onSave()) : (e.key === 'Backspace' && !tempValue && onRemoveItem(items.length - 1))}
  ...
  return (
    <div onClick={onOpen} className="cursor-pointer flex flex-wrap gap-1 hover:bg-[#0369a1]/5 p-1 rounded-lg transition-all min-h-[32px] items-center">
