      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-4 w-64 bg-white/90 backdrop-blur-2xl border border-[#0369a1]/10 rounded-3xl shadow-[0_32px_128px_rgba(0,0,0,0.15)] overflow-hidden animate-fade-in p-2">
          ...
          <div className="p-4 mb-2 bg-[#0369a1]/5 rounded-2xl flex flex-col items-center text-center">
            ...
            <div className="font-normal text-[#1a1a1a] line-clamp-1">{user.displayName}</div>
            <div className="text-[14px] font-normal text-slate-400 mt-1 line-clamp-1">{user.email}</div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center gap-4 px-4 py-3.5 text-red-500 hover:bg-red-50 rounded-2xl transition-all font-normal text-sm active:scale-95 group"
            >
