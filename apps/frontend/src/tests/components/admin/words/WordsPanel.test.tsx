...
import { WordsPanel } from '@/src/components/admin/words/WordsPanel';
...
const mockEntry = { id: 1, word: 'كىتاب' };
...
test('admin can delete a word after confirming', async () => {
  ...
  expect(setModal).toHaveBeenCalledWith(
    expect.objectContaining({
      ...
      type: 'confirm',
      destructive: true,
      message: 'admin.words.confirmDelete',
    })
  );
