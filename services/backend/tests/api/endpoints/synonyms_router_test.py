...
@pytest.mark.asyncio
async def test_delete_synonym_entry():
    setup_paths()
    from api.endpoints.synonyms_router import delete_synonym_entry
    ...
    result = await delete_synonym_entry(
...
@pytest.mark.asyncio
async def test_delete_synonym_entry_not_found():
    setup_paths()
    from api.endpoints.synonyms_router import delete_synonym_entry
