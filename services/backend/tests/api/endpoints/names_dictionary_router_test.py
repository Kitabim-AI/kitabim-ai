...
@pytest.mark.asyncio
async def test_delete_name_entry():
    setup_paths()
    from api.endpoints.names_dictionary_router import delete_name_entry
    ...
    result = await delete_name_entry(
...
@pytest.mark.asyncio
async def test_delete_name_entry_not_found():
    setup_paths()
    from api.endpoints.names_dictionary_router import delete_name_entry
