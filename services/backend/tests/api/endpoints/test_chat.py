...
async def test_chat_endpoint_uses_injected_rag_service():
    setup_paths()
    from api.endpoints.chat import chat_with_book_api
    ...
    with patch("api.endpoints.chat.chat_limit_service", mock_limit_service):
...
async def test_chat_stream_endpoint_uses_injected_rag_service():
    setup_paths()
    from api.endpoints.chat import chat_with_book_stream
    from app.models.schemas import ChatRequest
    from app.models.user import User
    import json
