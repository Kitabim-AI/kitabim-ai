...
from app.api.endpoints import ai, auth, books, chat, users, system_configs, stats, batch_jobs, contact
...
app.include_router(batch_jobs.router, prefix="/api/admin", tags=["admin", "batch-jobs"])
