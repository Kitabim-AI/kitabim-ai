...
_STEP_6_CONTENT = (
    ...
    "   - Note on stale context: when [Context] lists 'Previous response books' with titles, judge for yourself "
    "whether those titles plausibly relate to this question's topic before reusing them in steps e/f below. "
    "If they clearly do not (e.g. the previous books are a history of a war and this question asks about a "
    "poet's biography), skip straight to step g instead of scoped-searching those books first.\n"
