...
async def generate_answer_stream(
    ...
    *,
    ...
    if critique_feedback:
        instructions += (
            f"\n\nCORRECTION REQUIRED: A previous draft was rejected because: {critique_feedback} "
            "Ensure every claim in your answer is directly supported by the context above. "
