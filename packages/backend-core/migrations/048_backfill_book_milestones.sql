-- Backfill book-level milestone fields from current page states.
--
-- Fixes stale data caused by three bugs in the worker jobs:
--   1. spell_check_job never wrote page.spell_check_milestone = 'done' on success
--   2. chunking_job / embedding_job only updated pages[0].book_id after a batch
--   3. ocr_job skipped the book milestone update on PDF download failure
--
